...
& 'C:\Windows\Microsoft.NET\Framework64\v4.0.30319\csc.exe' /nologo /langversion:5 /target:library /optimize+ "/out:$output" $referenceArgs (Join-Path $PSScriptRoot 'Main.cs')
